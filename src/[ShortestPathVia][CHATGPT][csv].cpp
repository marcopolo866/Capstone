...
std::pair<std::vector<long long>, std::vector<int>> run_dijkstra(const std::vector<std::vector<Edge>>& adj, int start) {
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        auto [dist_s, parent_s] = run_dijkstra(in.adj, in.start);
        auto [dist_v, parent_v] = run_dijkstra(in.adj, in.via);
