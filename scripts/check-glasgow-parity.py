...
def main() -> int:
    ...
    parser.add_argument("--chatgpt-source", default="src/[SubgraphIsomorphism][CHATGPT][lad].cpp")
    parser.add_argument("--gemini-source", default="src/[SubgraphIsomorphism][GEMINI][lad].cpp")
